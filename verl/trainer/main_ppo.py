...
class TaskRunner:
    ...
    def run(self, config):
        ...
        reward_fn = load_reward_manager(
            config, tokenizer, m_tokenizer, num_examine=0, **config.reward_model.get("reward_kwargs", {})
        )
        val_reward_fn = load_reward_manager(
            config, tokenizer, m_tokenizer, num_examine=1, **config.reward_model.get("reward_kwargs", {})
        )
